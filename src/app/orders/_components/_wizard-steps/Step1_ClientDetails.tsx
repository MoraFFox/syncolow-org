...
export function Step1_ClientDetails({ companies }: Step1ClientDetailsProps) {
  ...
  const pendingClient = pendingClientId
    ? companies.find((c) => c.id === pendingClientId)
    : null;
                ...
                render={({ field }) => {
                  ...
                  return (
                    <>
                      ...
                      {parentCompany && (
                        <ClientPaymentStatusBar client={parentCompany} />
                      )}
                    </>
                  );
                }}
            ...
            render={({ field }) => (
              <div>
                ...
                <DeliveryScheduleBanner
                  schedule={field.value === "B" ? "B" : "A"}
                  show={!!field.value && field.value !== "Custom"}
                />
              </div>
            )}
          />
